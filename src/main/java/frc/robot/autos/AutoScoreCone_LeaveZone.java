...
public class AutoScoreCone_LeaveZone extends SequentialCommandGroup 
{
  ...
  public AutoScoreCone_LeaveZone(Arm arm, Intake intake, Extend extend, Wrist wrist, Swerve swerve) 
   {
    this.m_arm = arm;
    addRequirements(arm);
    this.m_wrist = wrist;
    ...
    addCommands(
      ...
      new Auton_TeleopSwerve(s_Swerve, -0.6, 0, 0, 4, 0, false)
