...
public class Example_Auto_Limelight extends SequentialCommandGroup 
{
    ...
    public Example_Auto_Limelight(Swerve swerve, Extend extend, Arm arm, Wrist wrist, Intake intake)
    {
        this.m_arm = arm;
        addRequirements(arm);
        this.m_wrist = wrist;
        ...
        PathPlannerTrajectory examplePath = PathPlanner.loadPath("2Piece_Limelight", new PathConstraints(4, 3));
