...
public class Red_Three_Piece_Auto extends SequentialCommandGroup 
{
  /** Creates a new One_Ball_Auto. */
  public Red_Three_Piece_Auto(Lift_Pneumatic m_lift, Swerve s_Swerve, Auton_Subsystem m_auto, Arm m_arm, Intake m_intake, Extend m_extend, Wrist m_wrist) 
   {
    ...
    TrajectoryGenerator.generateTrajectory(
     ...
     new Pose2d(-4.8768, 0, new Rotation2d(0)), // y:4064
     config
     );
     ...
     TrajectoryGenerator.generateTrajectory(
      ...
      List.of(new Translation2d(-3.42245, 0)),
      // End 3 meters straight ahead of where we started, facing forward
      new Pose2d(0, 0, new Rotation2d(0)), //y:4064
      config
      );
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        ...
        new ScoreMiddle(m_arm, Constants.ARM_SCORE_HIGH, m_wrist, Constants.WRIST_SCORE), new Auton_Wait(100)
      ),
      ...
      new ParallelCommandGroup(
        ...
        new ParallelRaceGroup(
          new ScoreMiddle(m_arm, Constants.ARM_PICKUP_CUBE, m_wrist, Constants.WRIST_PICKUP_CUBE), new Auton_Wait(100)
        )
      ),
