...
public class Auton_Approach_Bridge_Reverse_Swerve_Left extends CommandBase 
{    
    ...
    public Auton_Approach_Bridge_Reverse_Swerve_Left(Swerve swerve, double translation, int timeout) {
