...
public class Auton_Approach_Bridge_Reverse_Swerve_Right extends CommandBase 
{    
    ...
    public Auton_Approach_Bridge_Reverse_Swerve_Right(Swerve swerve, double translation, int timeout) {
    ...
    public void execute() 
    {
      ...
      if(pitch < 8 && timeout > count)
      {
       // translation = translation *s_Swerve.SpeedModifier;
        ...
        s_Swerve.drive
        (
          new Translation2d(translation, translation*0.4).times(Constants.Swerve.maxSpeed),
